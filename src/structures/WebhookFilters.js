...
WebhookFilters.DEFAULT = new WebhookFilters([
  ...
  'CREATE_LABEL', 'CREATE_CARD', 'CREATE_LIST', 'DELETE_CARD', 'DELETE_CHECK_ITEM', 'DELETE_LABEL',
  'MAKE_ADMIN_OF_BOARD', 'MAKE_NORMAL_MEMBER_OF_BOARD', 'REMOVE_CHECKLIST_FROM_CARD',
  'REMOVE_LABEL_FROM_CARD', 'REMOVE_MEMBER_FROM_BOARD','REMOVE_MEMBER_FROM_CARD',
  'UPDATE_CHECK_ITEM_STATE_ON_CARD','VOTE_ON_CARD', 'CREATE_CHECK_ITEM', 'DELETE_COMMENT', 'UPDATE_COMMENT',
  'UPDATE_BOARD_NAME', 'UPDATE_BOARD_CLOSED', 'UPDATE_CARD_NAME', 'UPDATE_CARD_LIST', 'UPDATE_CARD_CLOSED',
  'UPDATE_CHECK_ITEM_NAME', 'UPDATE_CHECKLIST_NAME', 'UPDATE_LIST_NAME', 'UPDATE_LIST_CLOSED',
  'UPDATE_CUSTOM_FIELD_ITEM']).bitfield;
